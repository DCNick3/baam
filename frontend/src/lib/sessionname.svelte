...
<div class="{$$props.class} flex flex-row border-[1px] transition-all ease-out shadow-gray-400 mb-4 mt-2 {style_classes}">
    <div class="p-2 bg-gray-200 text-gray-800"> Session name </div>
    <input class="pl-2 border-l-[1px] border-gray-300 text-gray-800 focus:outline-none flex-grow" type=text on:input={handleInput}>
</div>
